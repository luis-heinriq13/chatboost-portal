...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-white to-brand-50 opacity-70 pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 mb-12 lg:mb-0 z-10">
            <div className="animate-slide-down" style={{ animationDelay: "0.1s" }}>
              <Badge variant="outline" className="mb-4 py-1.5 border-brand-200 bg-brand-50 text-brand-800 font-medium">
                Transforme seu atendimento
              </Badge>
            </div>
            
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 leading-tight mb-6 tracking-tight animate-slide-down" style={{ animationDelay: "0.2s" }}>
              Revolucione seu <br />
            ...
            <p className="text-lg md:text-xl text-slate-700 mb-8 leading-relaxed max-w-xl animate-slide-down" style={{ animationDelay: "0.3s" }}>
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl overflow-hidden shadow-strong border border-slate-100 transition-all duration-300">
                <div className="h-12 bg-slate-50 border-b flex items-center px-4">
                  ...
                  <div className="mx-auto text-xs font-medium text-slate-500">WhatsNeed CRM - Dashboard</div>
                </div>
                <div className="aspect-[16/9] bg-gradient-to-br from-brand-100 to-brand-50 relative">
                  {/* We would add an actual screenshot or mockup image here */}
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                    <div className="w-full max-w-xs">
                      <div className="h-2 bg-slate-200 rounded mb-3 w-24 mx-auto"></div>
                      <div className="h-6 bg-slate-200 rounded mb-4 w-48 mx-auto"></div>
                      <div className="flex gap-4 mb-6 justify-center">
                        <div className="h-24 w-24 bg-white rounded-lg shadow-sm flex items-center justify-center">
              ...
              {/* Floating Elements */}
              <div className="absolute -bottom-4 -left-4 p-4 bg-white rounded-lg shadow-soft border border-slate-100 animate-float">
              ...
              <div className="absolute -top-4 -right-4 p-4 bg-white rounded-lg shadow-soft border border-slate-100 animate-float" style={{ animationDelay: "1s" }}>
                <div className="flex items-center gap-2">
